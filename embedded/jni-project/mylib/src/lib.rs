...
pub extern "system" fn Java_com_HelloWorld_hello(env: JNIEnv,
...
#[no_mangle]
#[allow(non_snake_case)]
pub extern "system" fn Java_com_HelloWorld_helloByte(env: JNIEnv,
                                             _class: JClass,
                                             input: jbyteArray)
                                             -> jbyteArray {
...
#[no_mangle]
#[allow(non_snake_case)]
pub extern "system" fn Java_com_HelloWorld_factAndCallMeBack(env: JNIEnv,
                                                         _class: JClass,
                                                         n: jint,
                                                         callback: JObject) {
    let i = n as i32;
...
#[no_mangle]
#[allow(non_snake_case)]
pub unsafe extern "system" fn Java_com_HelloWorld_counterNew(env: JNIEnv,
                                                         _class: JClass,
                                                         callback: JObject)
                                                         -> jlong {
...
#[no_mangle]
#[allow(non_snake_case)]
pub unsafe extern "system" fn Java_com_HelloWorld_counterIncrement(
    env: JNIEnv,
    _class: JClass,
    counter_ptr: jlong
){
...
#[no_mangle]
#[allow(non_snake_case)]
pub unsafe extern "system" fn Java_com_HelloWorld_counterDestroy(
    _env: JNIEnv,
    _class: JClass,
    counter_ptr: jlong
){
...
#[no_mangle]
#[allow(non_snake_case)]
pub extern "system" fn Java_com_HelloWorld_asyncComputation(
    env: JNIEnv,
    _class: JClass,
    callback: JObject,
) {
